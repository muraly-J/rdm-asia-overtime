...
EXPECTED = {
    (2026, 1): {
        ...
        'emp-599ec0979d': {'worked': 175.07, 'ot_weekday': 4.84, 'ot_saturday': 0.0, 'ot_sunday_ph': 0.0, 'ot_total': 4.84, 'anomalies': 1},
        ...
        'emp-5a20126feb': {'worked': 308.42, 'ot_weekday': 67.3, 'ot_saturday': 17.53, 'ot_sunday_ph': 24.15, 'ot_total': 108.98, 'anomalies': 8},
        'emp-4ae39072ff': {'worked': 317.93, 'ot_weekday': 93.69, 'ot_saturday': 42.25, 'ot_sunday_ph': 0.0, 'ot_total': 135.94, 'anomalies': 11},
    ...
    (2026, 2): {
        ...
        'emp-5a20126feb': {'worked': 184.72, 'ot_weekday': 37.73, 'ot_saturday': 5.63, 'ot_sunday_ph': 38.85, 'ot_total': 82.21, 'anomalies': 4},
        'emp-4ae39072ff': {'worked': 316.38, 'ot_weekday': 93.05, 'ot_saturday': 50.35, 'ot_sunday_ph': 0.0, 'ot_total': 143.4, 'anomalies': 7},
    ...
    (2026, 3): {
        ...
        "emp-8829911c06": {'worked': 186.18, 'ot_weekday': 9.74, 'ot_saturday': 5.22, 'ot_sunday_ph': 24.17, 'ot_total': 39.13, 'anomalies': 4},
        ...
        'emp-76892e4701': {'worked': 206.75, 'ot_weekday': 26.32, 'ot_saturday': 4.62, 'ot_sunday_ph': 10.75, 'ot_total': 41.69, 'anomalies': 1},
        'emp-5a20126feb': {'worked': 251.75, 'ot_weekday': 55.72, 'ot_saturday': 4.1, 'ot_sunday_ph': 24.15, 'ot_total': 83.97, 'anomalies': 8},
    ...
    (2026, 4): {
        ...
        'emp-a6eac3b874': {'worked': 223.05, 'ot_weekday': 30.21, 'ot_saturday': 0.0, 'ot_sunday_ph': 0.0, 'ot_total': 30.21, 'anomalies': 4},
        'emp-3b77f2677b': {'worked': 302.35, 'ot_weekday': 54.27, 'ot_saturday': 30.53, 'ot_sunday_ph': 42.64, 'ot_total': 127.44, 'anomalies': 9},
        "emp-8829911c06": {'worked': 257.1, 'ot_weekday': 32.92, 'ot_saturday': 7.53, 'ot_sunday_ph': 41.93, 'ot_total': 82.38, 'anomalies': 6},
        ...
        'emp-ca49f89f33': {'worked': 330.67, 'ot_weekday': 77.38, 'ot_saturday': 21.2, 'ot_sunday_ph': 14.06, 'ot_total': 112.64, 'anomalies': 2},
        'emp-76892e4701': {'worked': 233.3, 'ot_weekday': 40.63, 'ot_saturday': 9.15, 'ot_sunday_ph': 0.0, 'ot_total': 49.78, 'anomalies': 1},
        'emp-5a20126feb': {'worked': 331.32, 'ot_weekday': 72.91, 'ot_saturday': 17.6, 'ot_sunday_ph': 39.29, 'ot_total': 129.8, 'anomalies': 3},
    ...
    (2026, 5): {
        ...
        "emp-8829911c06": {'worked': 236.77, 'ot_weekday': 35.96, 'ot_saturday': 28.45, 'ot_sunday_ph': 33.97, 'ot_total': 98.38, 'anomalies': 15},
        ...
        'emp-76892e4701': {'worked': 250.9, 'ot_weekday': 41.07, 'ot_saturday': 10.88, 'ot_sunday_ph': 35.95, 'ot_total': 87.9, 'anomalies': 1},
        'emp-5a20126feb': {'worked': 238.8, 'ot_weekday': 34.65, 'ot_saturday': 44.87, 'ot_sunday_ph': 34.93, 'ot_total': 114.45, 'anomalies': 22},
        'emp-4ae39072ff': {'worked': 265.07, 'ot_weekday': 104.11, 'ot_saturday': 15.95, 'ot_sunday_ph': 0.0, 'ot_total': 120.06, 'anomalies': 9},
    ...
    (2026, 6): {
        ...
        'emp-9fb7dd1be7': {'worked': 306.02, 'ot_weekday': 75.45, 'ot_saturday': 16.45, 'ot_sunday_ph': 26.78, 'ot_total': 118.68, 'anomalies': 2},
        'emp-a6eac3b874': {'worked': 212.33, 'ot_weekday': 10.41, 'ot_saturday': 14.07, 'ot_sunday_ph': 9.58, 'ot_total': 34.06, 'anomalies': 0},
        'emp-3b77f2677b': {'worked': 244.1, 'ot_weekday': 44.63, 'ot_saturday': 47.91, 'ot_sunday_ph': 23.55, 'ot_total': 116.09, 'anomalies': 13},
        "emp-8829911c06": {'worked': 234.57, 'ot_weekday': 22.8, 'ot_saturday': 25.94, 'ot_sunday_ph': 28.73, 'ot_total': 77.47, 'anomalies': 5},
        ...
        'emp-ca49f89f33': {'worked': 327.22, 'ot_weekday': 75.96, 'ot_saturday': 21.52, 'ot_sunday_ph': 39.75, 'ot_total': 137.23, 'anomalies': 2},
        'emp-76892e4701': {'worked': 286.9, 'ot_weekday': 71.91, 'ot_saturday': 16.47, 'ot_sunday_ph': 26.75, 'ot_total': 115.13, 'anomalies': 3},
        'emp-5a20126feb': {'worked': 210.9, 'ot_weekday': 30.37, 'ot_saturday': 20.86, 'ot_sunday_ph': 47.3, 'ot_total': 98.53, 'anomalies': 11},
