...
EXPECTED = {
    (2026, 1): {
        ...
        'emp-4ae39072ff': {'worked': 317.93, 'ot_weekday': 66.36, 'ot_saturday': 42.25, 'ot_sunday': 0.0, 'ot_holiday': 0.0, 'ot_total': 108.61, 'anomalies': 11},
        'emp-5709d98bb7': {'worked': 0.0, 'ot_weekday': 0.0, 'ot_saturday': 0.0, 'ot_sunday': 0.0, 'ot_holiday': 0.0, 'ot_total': 0.0, 'anomalies': 0},
        'emp-599ec0979d': {'worked': 175.07, 'ot_weekday': 4.49, 'ot_saturday': 0.0, 'ot_sunday': 0.0, 'ot_holiday': 0.0, 'ot_total': 4.49, 'anomalies': 1},
        'emp-5a20126feb': {'worked': 308.42, 'ot_weekday': 53.4, 'ot_saturday': 17.53, 'ot_sunday': 11.55, 'ot_holiday': 0.0, 'ot_total': 82.48, 'anomalies': 8},
        'emp-76892e4701': {'worked': 215.75, 'ot_weekday': 29.37, 'ot_saturday': 2.77, 'ot_sunday': 0.0, 'ot_holiday': 0.0, 'ot_total': 32.14, 'anomalies': 2},
        'emp-8829911c06': {'worked': 184.25, 'ot_weekday': 18.45, 'ot_saturday': 0.0, 'ot_sunday': 0.0, 'ot_holiday': 7.8, 'ot_total': 26.25, 'anomalies': 4},
    ...
    (2026, 2): {
        ...
        'emp-5a20126feb': {'worked': 184.72, 'ot_weekday': 31.48, 'ot_saturday': 5.63, 'ot_sunday': 28.2, 'ot_holiday': 10.65, 'ot_total': 75.96, 'anomalies': 4},
        ...
        'emp-a6eac3b874': {'worked': 141.55, 'ot_weekday': 2.24, 'ot_saturday': 0.0, 'ot_sunday': 0.0, 'ot_holiday': 0.0, 'ot_total': 2.24, 'anomalies': 4},
    ...
    (2026, 3): {
        ...
        'emp-5a20126feb': {'worked': 251.75, 'ot_weekday': 49.04, 'ot_saturday': 4.1, 'ot_sunday': 13.58, 'ot_holiday': 0.0, 'ot_total': 66.72, 'anomalies': 8},
        'emp-76892e4701': {'worked': 206.75, 'ot_weekday': 26.32, 'ot_saturday': 0.0, 'ot_sunday': 10.75, 'ot_holiday': 0.0, 'ot_total': 37.07, 'anomalies': 1},
        'emp-8829911c06': {'worked': 186.18, 'ot_weekday': 5.96, 'ot_saturday': 5.22, 'ot_sunday': 24.17, 'ot_holiday': 0.0, 'ot_total': 35.35, 'anomalies': 4},
    ...
    (2026, 4): {
        'emp-3b77f2677b': {'worked': 302.35, 'ot_weekday': 54.27, 'ot_saturday': 30.53, 'ot_sunday': 42.64, 'ot_holiday': 0.0, 'ot_total': 127.44, 'anomalies': 9},
        ...
        'emp-8829911c06': {'worked': 257.1, 'ot_weekday': 32.29, 'ot_saturday': 7.53, 'ot_sunday': 41.93, 'ot_holiday': 0.0, 'ot_total': 81.75, 'anomalies': 6},
        'emp-9fb7dd1be7': {'worked': 256.82, 'ot_weekday': 58.8, 'ot_saturday': 0.0, 'ot_sunday': 0.0, 'ot_holiday': 0.0, 'ot_total': 58.8, 'anomalies': 0},
        'emp-a6eac3b874': {'worked': 223.05, 'ot_weekday': 27.01, 'ot_saturday': 0.0, 'ot_sunday': 0.0, 'ot_holiday': 0.0, 'ot_total': 27.01, 'anomalies': 4},
        'emp-ad987e0f1a': {'worked': 252.47, 'ot_weekday': 57.89, 'ot_saturday': 0.0, 'ot_sunday': 17.83, 'ot_holiday': 0.0, 'ot_total': 75.72, 'anomalies': 0},
        'emp-ca49f89f33': {'worked': 330.67, 'ot_weekday': 76.5, 'ot_saturday': 21.2, 'ot_sunday': 14.06, 'ot_holiday': 0.0, 'ot_total': 111.76, 'anomalies': 2},
        'emp-e3a8636105': {'worked': 184.63, 'ot_weekday': 4.63, 'ot_saturday': 0.0, 'ot_sunday': 0.0, 'ot_holiday': 0.0, 'ot_total': 4.63, 'anomalies': 0},
    },
    (2026, 5): {
        'emp-3b77f2677b': {'worked': 262.43, 'ot_weekday': 54.46, 'ot_saturday': 44.83, 'ot_sunday': 26.05, 'ot_holiday': 0.0, 'ot_total': 125.34, 'anomalies': 10},
        'emp-4ae39072ff': {'worked': 265.07, 'ot_weekday': 97.19, 'ot_saturday': 15.95, 'ot_sunday': 0.0, 'ot_holiday': 0.0, 'ot_total': 113.14, 'anomalies': 9},
        ...
        'emp-5a20126feb': {'worked': 238.8, 'ot_weekday': 12.58, 'ot_saturday': 44.87, 'ot_sunday': 13.05, 'ot_holiday': 0.0, 'ot_total': 70.5, 'anomalies': 22},
        'emp-76892e4701': {'worked': 250.9, 'ot_weekday': 41.07, 'ot_saturday': 10.88, 'ot_sunday': 10.4, 'ot_holiday': 13.18, 'ot_total': 75.53, 'anomalies': 1},
        'emp-8829911c06': {'worked': 236.77, 'ot_weekday': 29.3, 'ot_saturday': 28.45, 'ot_sunday': 33.97, 'ot_holiday': 0.0, 'ot_total': 91.72, 'anomalies': 15},
    ...
    (2026, 6): {
        'emp-3b77f2677b': {'worked': 244.1, 'ot_weekday': 37.71, 'ot_saturday': 47.91, 'ot_sunday': 12.37, 'ot_holiday': 11.18, 'ot_total': 109.17, 'anomalies': 13},
        ...
        'emp-5a20126feb': {'worked': 210.9, 'ot_weekday': 21.81, 'ot_saturday': 20.86, 'ot_sunday': 9.18, 'ot_holiday': 24.72, 'ot_total': 76.57, 'anomalies': 11},
        'emp-76892e4701': {'worked': 286.9, 'ot_weekday': 67.79, 'ot_saturday': 16.47, 'ot_sunday': 13.75, 'ot_holiday': 13.0, 'ot_total': 111.01, 'anomalies': 3},
        'emp-8829911c06': {'worked': 234.57, 'ot_weekday': 19.17, 'ot_saturday': 25.94, 'ot_sunday': 21.0, 'ot_holiday': 7.73, 'ot_total': 73.84, 'anomalies': 5},
        'emp-9fb7dd1be7': {'worked': 306.02, 'ot_weekday': 71.33, 'ot_saturday': 16.45, 'ot_sunday': 13.8, 'ot_holiday': 12.98, 'ot_total': 114.56, 'anomalies': 2},
        ...
        'emp-ca49f89f33': {'worked': 327.22, 'ot_weekday': 74.46, 'ot_saturday': 21.52, 'ot_sunday': 18.32, 'ot_holiday': 21.43, 'ot_total': 135.73, 'anomalies': 2},
        'emp-e3a8636105': {'worked': 186.57, 'ot_weekday': 15.74, 'ot_saturday': 0.0, 'ot_sunday': 0.0, 'ot_holiday': 0.0, 'ot_total': 15.74, 'anomalies': 1},
    },
}
